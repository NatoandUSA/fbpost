...
$files = @('ai_spinner.py','brand_profiles.py','db.py','fb_auth.py','fb_comment.py','fb_create_page.py','fb_group.py','fb_interact.py','fb_join_group.py','fb_page.py','fb_reconcile.py','fb_page_api.py','fb_scraper.py','fb_thread.py','main.py','paths.py','scheduler.py','server.py','utils.py','README.md','HUONG_DAN_SU_DUNG.html','requirements.txt','RUN_FB_AUTOMATION.bat','START_LINUX.sh','START_MAC.command','start_portable.bat','VERSION')
