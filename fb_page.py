...
def post_to_page(page_url, content, image_path=None, account_id=None, gpm_api_url=None, feeling=False, checkin=False,
    ...
    if skip_duplicate:
        ...
        if is_dup:
            ...
            return ActionResult(success=True, code="SKIPPED_DUPLICATE", state="skipped_duplicate", message=f"Trang {page_url} đã được đăng lúc {posted_at}.", target_url=page_url)
