    ...
    def run_command_sync(
        ...
        if on_line:
            try:
                ...
                pass
        # The tailer starts after the identity marker because the marker is emitted
        # synchronously above. Child output remains file-backed, while worker PID
        # exit—not pipe EOF—is the lifecycle authority.
